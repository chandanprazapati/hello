...
const FineSchema = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/revenue/fineschema/createfineschema/${id}`);
  };
  ...
  return (
      ...
      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/revenue/fineschema/createfineschema");
          }}
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
                ...
                <TableCell sx={{ fontSize: "20px" }}>जरिवाना दर (%) </TableCell>
            ...
            <TableBody>
              {apiData.map((row, index) => {
                ...
                >
                    ...
                    <TableCell>{row.penaltyPercent}</TableCell>
