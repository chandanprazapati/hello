...
export default function TaxModule() {
  ...
  const handleEdit = (id) => {
    router.push(`/revenue/taxModule/createTaxModule/${id}`);
  };
  ...
  return (
    <ListViewPageDesign>
      <ListHeader title="कर मोड्युल  सूची" />
      <ListButton url={`/revenue/taxModule/createTaxModule`} />
