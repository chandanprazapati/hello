...
export default function VehicleCloseReason  ()  {
  ...
  const handleEdit = (id) => {
    router.push(`/revenue/vehicleClose/createVehicleClose/${id}`);
  };
  const locale = (
  ...
  return (
    <ListViewPageDesign>
      <ListHeader title="वाहन-रद्द कारण  सूची" />
      <ListButton url={`/revenue/vehicleClose/createVehicleClose`} />
