...
import { createBusinessType } from "../../../services/apiServices/revenue/businessType/businessTypeService";
import CommonHeaderDesign from "../../reusableDesign/CommonHeaderDesign";
import AddButton from "../../reusableDesign/AddButton";

const CreateBusinessType = ({ clickedIdData }) => {
  ...
  return (
    <>
      <CommonHeaderDesign title={"व्यापार राख्नुहोस"} />
