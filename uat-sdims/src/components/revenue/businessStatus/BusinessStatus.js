...
export default function BusinessStatus() {
  ...
  const handleEdit = (id) => {
    router.push(`/revenue/businessStatus/createBusinessStatus/${id}`);
  };
  const locale = (
  ...
  return (
    <ListViewPageDesign>
      <ListHeader title="व्यापार-स्थिति  सूची" />
      <ListButton url={`/revenue/businessStatus/createBusinessStatus`} />
