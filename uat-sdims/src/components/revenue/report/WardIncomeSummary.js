...
const GetWardIncomeSummary = () => {
  ...
  return (
    <>
      <CommonHeaderDesign title={"आम्दानि विवरणको सारांश"} />
...
<TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>गाउँ कार्यपालिकाको कार्यालय</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>wada no.</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>कच्चि घर</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>1</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>2</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>3</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>4</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>5</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>6</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>7</TableCell>
...
export default GetWardIncomeSummary;