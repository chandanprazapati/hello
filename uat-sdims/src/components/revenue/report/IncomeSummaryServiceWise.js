...
const GetIncomeSummaryServiceWise = () => {
  const {
    register,
    handleSubmit,
  ...
  const onSubmit = (data) => {
    return new Promise((resolve) => {
     ...
     if (counterValue === 0) {
        ...
        data = { ...data, wardId: wardValue, invoiceDateStart: new Date(BS.BSToAD(startNepDate)), invoiceDateEnd:new Date(BS.BSToAD(endNepDate)) , counterId: counterValue, serviceId: serviceId };
      }
        try {
  ...
  return (
    <>
      <CommonHeaderDesign title={"आय शिर्षक अनुसार आम्दानि विवरण"} />
...
<TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>कर / शुल्क</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>छुट</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>जरिवाना</TableCell>
...
export default GetIncomeSummaryServiceWise