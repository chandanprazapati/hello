...
const GetInvoiceTranscation = () => {
  ...
  return (
    <>
      <CommonHeaderDesign title={"इनभ्वाइस लेनदेन"} />
        ...
        <div className="grid lg:grid-cols-5 shadow-2xl bg-gray-100 gap-5 px-5 pt-10 border border-black border-dashed ">
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              placeholder="."
            />
            <label className="label">करदाताको नाम</label>
          ...
          <div className="relative z-0 w-full mb-6 group">
            <input
              ...
              placeholder="."
            />
            <label className="label">वडा न.</label>
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>माध्यम</TableCell>
...
export default GetInvoiceTranscation;
