...
const IptTaxPayerSummary= () => {
  ...
  return (
    <>
      <CommonHeaderDesign title={"रकम अनुसारको(Descending Order)सम्पत्ति /मालपोत तथा भूमिकरको सूची"} />
...
<TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>बिल नं		</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>करदाता	</TableCell>
                <TableCell sx={{ fontSize: "20px" }}>जम्मा रकम रु.</TableCell>
...
export default IptTaxPayerSummary