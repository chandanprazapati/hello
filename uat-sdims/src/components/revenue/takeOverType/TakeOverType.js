...
export default function TakeOverType() {
  ...
  const handleEdit = (id) => {
    router.push(`/revenue/takeOver/createTakeOver/${id}`);
  };
  ...
  return (
    <ListViewPageDesign>
      <ListHeader title="वाहन-हस्तांतरण  सूची" />
      <ListButton url={`/revenue/takeOver/createTakeOver`} />
