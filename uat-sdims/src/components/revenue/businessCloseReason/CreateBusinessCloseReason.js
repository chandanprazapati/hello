...
export default function CreateBusinessCloseReason  ({ clickedIdData })  {
  ...
  const onSubmit = useCallback(
    async (data) => {
      try {
        ...
        const response = await createBusinessCloseReason(data);
  ...
  return (
    <>
      <CommonHeaderDesign title={"व्यापार-बन्द कारण राख्नुहोस "} />
