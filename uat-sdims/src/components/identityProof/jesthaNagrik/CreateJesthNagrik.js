...
import JesthNagrikDetails from "../formFields/JesthNagrikDetails";
export default function CreateJesthNagrik() {
    ...
    >
      ...
      <div className="w-full mx-auto rounded-2xl bg-gray-200 pb-2 shadow-xl">
        ...
        <div className="horizontal container mt-5 mb-10">
          <ListHeader title ={"जेष्ठ नागरिक दर्ता फारम"} />
