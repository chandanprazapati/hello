...
export default function Disabled() {
  ...
  const handleEdit = useCallback(
    (id) => {
      router.push(`/identityProof/seniorCitizen/createSeniorCitizen/${id}`);
    },
    [router]
  );
  ...
  return (
    <ListVIewPageDesign>
      <ListHeader title="जेष्ठ नागरिक सूची" />
      <ListButton url={`/identityProof/seniorCitizen/createSeniorCitizen`} />
