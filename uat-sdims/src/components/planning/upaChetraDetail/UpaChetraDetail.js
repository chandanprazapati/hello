...
import { deleteUpaChetra } from "../../../services/apiServices/planning/upaChetra/upaChetraService";
...
const UpaChetra = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/planning/upachetradetail/createupachetradetail/${id}`);
  };
  ...
  return (
    <div className=" rounded-2xl shadow-2xl pb-4 pt-2 px-5 flex flex-col gap-1  divide-black  ">
      <div className="text-4xl font-bold items-center flex justify-center pt-5  ">
        उप क्षेत्र विवरण सूची
      </div>

      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/planning/upachetradetail/createupachetradetail");
          }}
              ...
              {apiData.map((row, index) => {
                return (
                  <TableRow key={index} className="hover:bg-[#a0cae7fd]">
                    ...
                    <TableCell>{row.upaChetraName}</TableCell>
                    ...
                    <TableCell className="pl-7 cursor-pointer ">
                      <div className="flex gap-10 ">
                        <div
                          ...
                          onClick={() => {
                            handleEdit(row.upaChetraDetailId);
                          }}
                        >
                          <FaEdit size={20} />
                        </div>
                        <div
                          ...
                          onClick={() => {
                            handleDelete(row.upaChetraDetailId);
                          }}
                        >
                          <FaTrashAlt size={20} />
                          <DeleteModal
