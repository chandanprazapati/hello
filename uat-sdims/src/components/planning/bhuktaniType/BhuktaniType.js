...
import {
  bhuktaniType,
  deleteBhuktaniType,
} from "../../../services/apiServices/planning/bhuktaniType/bhuktaniTypeService";
const BhuktaniType = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/planning/bhuktani/createbhuktani/${id}`);
  };
  ...
  return (
    <div className=" rounded-2xl shadow-2xl pb-4 pt-2 px-5 flex flex-col gap-1  divide-black  ">
      <div className="text-4xl font-bold items-center flex justify-center pt-5  ">
        भुक्तानी प्रकार सूची
      </div>

      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/planning/bhuktani/createbhuktani");
          }}
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>भुक्तानी प्रकार</TableCell>
              ...
              {apiData.map((row, index) => {
                return (
                  <TableRow key={index} className="hover:bg-[#a0cae7fd]">
                    ...
                    <TableCell>{row.bhuktaniTypeName}</TableCell>
                    ...
                    <TableCell className="pl-7 cursor-pointer ">
                      <div className="flex gap-10 ">
                        ...
                        <div
                          ...
                          onClick={() => {
                            handleDelete(row.bhuktaniTypeId);
                          }}
                        >
                          <FaTrashAlt size={20} />
                          <DeleteModal
