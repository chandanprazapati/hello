...
import {
  budgetType,
  deleteBudgetType,
} from "../../../services/apiServices/planning/budgetType/budgetTypeService";
const BudgetType = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/planning/budgettype/createbudgettype/${id}`);
  };
  ...
  const handleOk = () => {
    deleteBudgetType(deleteId).then((response) => {
      try {
        response.status === true;
        {
...
बजेट  प्रकार सूची
      ...
      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/planning/budgettype/createbudgettype");
          }}
