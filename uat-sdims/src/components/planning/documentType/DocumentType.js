...
import {
  deleteDocumentType,
  documentType,
} from "../../../services/apiServices/planning/documentType/documentTypeService";
const DocumentType = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/planning/document/createdocument/${id}`);
  };
  ...
  const handleOk = () => {
    deleteDocumentType(deleteId).then((response) => {
      try {
        response.status === true;
        {
  ...
  return (
    <div className=" rounded-2xl shadow-2xl pb-4 pt-2 px-5 flex flex-col gap-1  divide-black  ">
      ...
      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/planning/document/createdocument");
          }}
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow className="bg-[#3e8dc1fd]">
                ...
                <TableCell sx={{ fontSize: "20px" }}>कागजात प्रकार </TableCell>
                    ...
                    <TableCell className="pl-7 cursor-pointer ">
                      <div className="flex gap-10 ">
                        ...
                        <div
                          ...
                          onClick={() => {
                            handleDelete(row.documentTypeId);
                          }}
                        >
                          <FaTrashAlt size={20} />
                          <DeleteModal
