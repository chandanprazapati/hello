...
import { chetra, deleteChetra } from "../../../services/apiServices/planning/chetra/chetraService";
const Chetra = () => {
  ...
  const handleEdit = (id) => {
    router.push(`/planning/chetra/createchetra/${id}`);
  };
  ...
  const handleOk = () => {
    deleteChetra(deleteId).then((response) => {
      try {
        response.status === true;
        {
  ...
  return (
      ...
      <div className="flex justify-end ">
        <div
          onClick={() => {
            router.push("/planning/chetra/createchetra");
          }}
