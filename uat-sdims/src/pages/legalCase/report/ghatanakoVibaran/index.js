...
import { getGhatanakoBiwaranReport } from "../../../../services/apiServices/legalCase/legalCaseService";
...
export default function NivedanPatraDhacha() {
  ...
  useEffect(() => {
    const fetchedData = async () => {
        getGhatanakoBiwaranReport().then(({ status, data, message }) => {
        try {
          if (status) {
            setApiData(data);
            setLoading(false);
  ...
  return (
    <>
    <SeoOptimization title="घटनाको विवरण" description="घटनाको विवरण" />
...
const tableHeadData = [
  { id: "id", name: "क्र.नं." },
  { id: "mamilaName", name: " दर्ता मिति		" },
  { id: "mamilaType", name: "	दर्ता चलानी नं" },
  { id: "mamilaType", name: "	नाम थर (वादी)			" },
  // { id: "action", name: "पक्षको ठेगाना र मोबाइल नम्बर	" },
  { id: "action", name: "नाम थर(प्रतिवादी)			" },
  // { id: "action", name: "विपक्षको ठेगाना र मोबाइल नम्बर	" },
  { id: "action", name: "घटनाको प्रकार" },
  { id: "action", name: "हालको अवस्था" },
