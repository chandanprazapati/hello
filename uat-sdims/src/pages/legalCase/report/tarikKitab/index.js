...
import { getTarikKitabReport, } from "../../../../services/apiServices/legalCase/legalCaseService";
...
export default function NivedanPatraDhacha() {
  ...
  useEffect(() => {
    const fetchedData = async () => {
        getTarikKitabReport().then(({ status, data, message }) => {
        try {
          if (status) {
            setApiData(data);
            setLoading(false);
        ...
        {apiData.map((row, index) => {
          return (
            <TableRow key={index} className="hover:bg-[#a0cae7fd]">
              ...
              <TableCell> {row.firstHearingDate}</TableCell>
  ...
  return (
    <>
      <SeoOptimization title=" तारिक किताब" description=" तारिक किताब" />
          ...
          <div className="bg-[url('https://res.cloudinary.com/dg1opyudu/image/upload/v1684819916/1_ga21iq.jpg')] rounded-xl p-5 w-full ">
            <div className="flex justify-between pb-10  ">
              ...
              <div>
                ...
                <div className="text-center font-bold ">तारिक किताब</div>
              </div>
...
const tableHeadData = [
  { id: "id", name: "क्र.नं.	" },
  { id: "name", name: "दर्ता नं				" },
  { id: "mamilaName", name: "	दर्ता मिति			" },
  { id: "mamilaType", name: "	बढीको नाम		" },
  { id: "mamilaType", name: "	प्रतिबादिको नाम			" },
  { id: "action", name: "तारिक मिति		" },
  { id: "action", name: "समय			" },
  { id: "action", name: "तारिक मिति		" },
  { id: "action", name: "समय" },
  { id: "action", name: "तारिक मिति	" },
