...
const CreateBudgetSubTypeById = () => {
  ...
  let filteredData = apiData.find((item) => item.id === parseInt(query.id));
  ...
  return (
    <>
      ...
      {loading ? (
        ...
        <CreateBudgetSubTypeX clickedIdData={filteredData} />
      )}
    </>
  );
};

export default CreateBudgetSubTypeById;
