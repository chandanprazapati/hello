...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/khullaDhacha/createKhullaDhacha/${id}`);
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Khulla Dhacha"} />
      <ListViewPageDesign>
        <ListHeader title="खुल्ला ढाचा सिफारिस सूची" />
        <ListButton url={`/sifarish/khullaDhacha/createKhullaDhacha`} />
