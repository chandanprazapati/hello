...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/propertyValuation/createPropertyValuation/${id}`);
  };
  ...
  return (
    <React.Fragment>
      ...
      <ListViewPageDesign>
        <ListHeader title="Propert Valuation सूची" />
        <ListButton url={`/sifarish/propertyValuation/createPropertyValuation`} />
...
const tableHeadData = [
  ...
  { id: "fullName", name: "नाम थर(In English)	" },
  { id: "nagiritaNo", name: "ना.प्र.प.नं.	" },
  { id: "phoneNo", name: "गा.पा./न.पा.	" },
