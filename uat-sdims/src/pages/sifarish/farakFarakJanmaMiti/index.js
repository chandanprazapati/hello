...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/farakFarakJanmaMiti/createFarakFarakJanmaMiti/${id}`);
  };
  ...
  return (
    <React.Fragment>
      ...
      <ListViewPageDesign>
        ...
        <ListButton url={`/sifarish/farakFarakJanmaMiti/createFarakFarakJanmaMiti`} />
...
const tableHeadData = [
  { id: "id", name: "सि.नं." },
  { id: "fullName", name: "बाबुको नाम थर	" },
  { id: "fullName", name: "आमाको नाम थर	" },
  {id:"name",name:"नाम थर	"},
