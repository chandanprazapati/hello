...
import { getScholarship } from "../../../services/apiServices/sifarish/scholarship/scholarshipService";
...
export default function index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/scholarship/createScholarship/${id}`);
  };
  const handleDetail = (id) => {
    router.push(`/sifarish/scholarship/details/${id}`);
  };
  const handleUploadDocs = (id) => {
    router.push(`/sifarish/scholarship/uploadDocs/${id}`);
  };
  const handlePrint = (id) => {
    router.push(`/sifarish/scholarship/printScholarship/${id}`);
  };
  ...
  return (
    <>
      <SeoOptimization title={"scholarship"} />
      <ListViewPageDesign>
        <ListHeader title="छात्रवृत्ति" />
        <ListButton url={`/sifarish/scholarship/createScholarship`} />
