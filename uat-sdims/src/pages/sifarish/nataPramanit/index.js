...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/nataPramanit/createNataPramanit${id}`);
  };
  ...
  return (
    <React.Fragment>
      ...
      <ListViewPageDesign>
        <ListHeader title="नाता प्रमाणित सिफारिस सूची" />
        <ListButton url={`/sifarish/nataPramanit/createNataPramanit`} />
...
const tableHeadData = [
  ...
  { id: "nagiritaNo", name: "प्रमाणित प्रकार" },
