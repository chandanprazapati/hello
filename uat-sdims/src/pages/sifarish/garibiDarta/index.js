...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/garibiDarta/createGaribiDarta/${id}`);
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Garibi Darta"} />
      <ListViewPageDesign>
        <ListHeader title="गरिबी दर्ता सूची" />
        <ListButton url={`/sifarish/garibiDarta/createGaribiDarta`} />
...
const tableHeadData = [
  { id: "id", name: "सि.नं." },
  { id: "fullName", name: "बाबुको नाम	" },
  { id: "fullName", name: "आमाको नाम	" },
