...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/gharJaggaKar/createGharJaggaKar/${id}`);
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Ghar Jagga Kar"} />
      <ListViewPageDesign>
        <ListHeader title="घर जग्गा कर सिफारिस सूची" />
        <ListButton url={`/sifarish/gharJaggaKar/createGharJaggaKar`} />
