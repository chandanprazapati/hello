...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/businessRenewal/createBusinessRenewal/${id}`);
  };
  ...
  return (
    <React.Fragment>
      ...
      <ListViewPageDesign>
        <ListHeader title="व्यवसाय नविकरण दर्ता सूची" />
        <ListButton url={`/sifarish/businessRenewal/createBusinessRenewal`} />
