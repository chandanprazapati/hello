...
import { getAadibasiJanjatiFiles, insertAadibasiJanjatiFiles } from "../../../../services/apiServices/sifarish/aadiwasiJanajaati/aadiwasiJanjatiService";
export default function Details() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      formData.append("AadiwasiId", query.id);
      ...
      const response = await insertAadibasiJanjatiFiles(formData);
  ...
  return (
    <div>
      <CommonHeaderDesign title={"आदिवासी/जनजाती  सिफारिस कागजात अप्लोअड"} />
