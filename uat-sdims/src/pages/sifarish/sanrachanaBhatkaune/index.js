...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(
      `/sifarish/sanrachanaBhatkaune/createSanrachanaBhatkaune/${id}`
    );
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Sanrachana Bhatkaune"} />
      <ListViewPageDesign>
        <ListHeader title="संरचना भत्काउने सिफारिस सूची" />
        <ListButton
          url={`/sifarish/sanrachanaBhatkaune/createSanrachanaBhatkaune`}
        />
...
const tableHeadData = [
  { id: "id", name: "सि.नं." },
  { id: "fullName", name: "सूचकको नाम थर" },
  { id: "nagiritaNo", name: "सूचकको फोन नम्बर" },
  { id: "status", name: "नागरकिता नं" },
  { id: "phoneNo", name: "जम्मा तल्ला" },
