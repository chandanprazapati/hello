...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/janmaBasobasPramanit/createJanmaBasobasPramanit/${id}`);
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Janma/Basobas"} />
      <ListViewPageDesign>
        <ListHeader title="जन्म बसोबास/मिति सिफारिस सूची" />
        <ListButton url={`/sifarish/janmaBasobasPramanit/createJanmaBasobasPramanit`} />
