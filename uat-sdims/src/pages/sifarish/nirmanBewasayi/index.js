...
export default function Index() {
  ...
  const handleEdit = (id) => {
    router.push(`/sifarish/nirmanBewasayi/createNirmanBewasayi/${id}`);
  };
  ...
  return (
    <React.Fragment>
      <SeoOptimization title={"Nirman Bewasayi"} />
      <ListViewPageDesign>
        <ListHeader title="निर्माण व्यवसाय सूची" />
        <ListButton url={`/sifarish/nirmanBewasayi/createNirmanBewasayi`} />
...
const tableHeadData = [
  { id: "id", name: "सि.नं." },
  { id: "fullName", name: "नाम" },
  { id: "fullName", name: "ठेगाना" },
  { id: "nagiritaNo", name: "टेलिफोन नं	" },
  { id: "phoneNo", name: "प्यान नं" },
